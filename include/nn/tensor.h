...
public :
    Tensor(float data, bool requires_bool =false ,
        std::function<void(const std::vector<float>&)> _gradfn = nullptr ,
        std::vector<std::shared_ptr<Tensor>> parents = {});
    Tensor(std::vector<float> data , bool requires_bool =false ,
        std::function<void(const std::vector<float>&)> _gradfn = nullptr ,
        std::vector<std::shared_ptr<Tensor>> parents = {});
    Tensor(std::vector<std::vector<float>> data, bool requires_bool =false ,
        std::function<void(const std::vector<float>&)> _gradfn = nullptr ,
        std::vector<std::shared_ptr<Tensor>> parents = {});
